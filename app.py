...
def main(inputs):
    ...
    with hellow as source:
        ...
        # samplerate, audio = wavfile.read(inputs)
        
 
        print("TAnish jarayoni....")


 
        try:
            return r.recognize_google(audio,language="Uz-us")
...
OUTPUT_OK = (
    ...
    + """
    <div class="container">
        <div class="row"><h1 style="text-align: center">Ovoz beruvchi</h1></div>
        <div class="row"><h1 class="display-1 text-success" style="text-align: center">{:.1f}%</h1></div>
        <div class="row"><h1 style="text-align: center">O'xshash</h1></div>
        <div class="row"><h1 class="text-success" style="text-align: center">Qabul qilindi</h1></div>
        <div class="row"><h1 style="text-align: center">{}</h1></div> 
...
def similarity_fn(path1, path2):
    ...
    if similarity >= THRESHOLD:
        a = main(path1)
        output = OUTPUT_OK.format(similarity * 100, a)
...
interface = gr.Interface(
    ...
    inputs=inputs,
    outputs=output,
    title="Ovoz orqali identifikatsion boshqaruv",
